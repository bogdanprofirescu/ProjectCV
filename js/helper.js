...
var HTMLonlineschoolStart = '<div class="onlineedu-entry"></div>';
var HTMLonlineClasses = '<br><h3>Online Classes</h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text">%data%</div><br>';
var HTMLonlineURL = '<a href="#" target="_blank">%data%</a><br>';

var internationalizeButton = '<button>Internationalize SURNAME</button>';
